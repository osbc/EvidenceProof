...
/*        consensus.nRuleChangeActivationThreshold = 1916; // 95% of 2016
        ...
        //存证平台的参数
        consensus.nRuleChangeActivationThreshold = 0.95 * (consensus.nPowTargetTimespan / consensus.nPowTargetSpacing); // 95% of 2016
        ...
        consensus.nMinimumChainWork = uint256S("0x00");//存证平台
